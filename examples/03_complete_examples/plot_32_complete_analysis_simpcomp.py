...
data_dir = op.join(os.getenv('ROOTDIR'), 'bids_dataset')
...
############################################################################
# We just expect 4 run img per subject.
...
for midx, (model, imgs, events, confounds) in enumerate(model_and_args):
    ...
    zmap = model.compute_contrast('verb-list-4')
